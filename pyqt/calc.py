...
class Calculator(QWidget):
    ...
    def initUI(self):
        self.setGeometry(300, 300, 290, 370)
        self.setWindowTitle("Калькулятор")

        self.label = QLabel(self)
        self.label.setText('0')
        self.label.resize(229, 95)
        ...
        self.dell = QPushButton('%', self)
        self.dell.resize(50, 50)
        self.dell.move(225, 100)

        self.dele = QPushButton('//', self)
        self.dele.resize(50, 50)
        self.dele.move(225, 155)

        self.kvad = QPushButton('**', self)
        self.kvad.resize(50, 50)
        self.kvad.move(225, 210)
        ...
        self.dell.clicked.connect(self.dell_1)
        self.dele.clicked.connect(self.dl_1)
